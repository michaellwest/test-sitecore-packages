...
docker exec --user ContainerAdministrator "$($composeProjectName)-mssql-1" powershell C:\releases\scripts\sql.ps1
docker exec --user ContainerAdministrator "$($composeProjectName)-cm-1" powershell C:\releases\scripts\cm.ps1